...
In 2016, the Open Government Partnership (OGP) Paris Summit [demonstrated](https://www.opengovpartnership.org/wp-content/uploads/2018/07/France_End-of-Term_Report_2015-2017.pdf) the international value of OpenFisca when a small team of OpenFisca France maintainers and OpenFisca Tunisia volunteers managed to [model](https://github.com/openfisca/openfisca-senegal) Sénégal's income revenue tax in under 36 hours, with a simulator shipped complete with a web UI during the OGP hackathon, winning the team the first prize.
