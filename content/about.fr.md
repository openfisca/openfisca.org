...
<ul>
    <li>arrêter le développement de la [version Qt](https://github.com/openfisca/openfisca-qt) ;</li>
    <li>séparer le moteur de calcul de son interface utilisateur de bureau ;</li>
    <li>proposer une API web en plus de l'API Python ;</li>
    <li>démontrer la valeur de l'API web en développant des applications incluant une interface web ;</li>
    <li>offrir un accès public à cette API web.</li>
</ul>
