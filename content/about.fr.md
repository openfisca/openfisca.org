...
Le développement d'OpenFisca a commencé en mai 2011 au [Centre d'analyse stratégique](https://strategie.gouv.fr/) (renommé _France Stratégie_ en avril 2013), avec le soutien de l'[<abbr title="Institut d'économie publique">IDEP</abbr>](https://www.idep-fr.org/).
...
Le moteur a été largement amélioré par Etalab, tandis que le modèle français a été amélioré et mis à jour par le [Commissariat général à la stratégie et à la prospective (CGSP)](https://strategie.gouv.fr/) avec l'aide de l'[Institut d'économie publique (IDEP)](https://www.idep-fr.org/) et de l'[Institut des politiques publiques (IPP)](https://www.ipp.eu/). Quelques mois plus tard, [beta.gouv.fr](https://beta.gouv.fr) a commencé à utiliser l'API et à étendre le modèle pour fournir des services publics numériques, en déployant un premier outil consolidé d'évaluation des prestations destiné aux citoyens, _Mes Aides_, et un calculateur de bulletin de salaire.

En 2016, le Sommet de l'Open Government Partnership (OGP) à Paris a [démontré](https://www.opengovpartnership.org/wp-content/uploads/2018/07/France_End-of-Term_Report_2015-2017.pdf) la valeur internationale d'OpenFisca : une petite équipe de mainteneurs d'OpenFisca France et de volontaires d'OpenFisca Tunisie a réussi à [modéliser](https://github.com/openfisca/openfisca-senegal) l'impôt sur le revenu du Sénégal en moins de 36 heures, en livrant un simulateur complet doté d'une interface web pendant le hackathon de l'OGP, remportant le premier prix.
