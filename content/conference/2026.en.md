...
- **10:25 - How Assemblic uses AI to reduce the cost of implementing Rules as Code** _(sponsor speech)_
Philippa Martin, Assemblic
- **10:30 - The economic relevance of Rules as Code**
Tim De Sousa, FTI Consulting
- **10:40 - The OpenFisca Association’s first year of operation: structuring digital commons**
Matti Schneider, Executive Director, OpenFisca Association
- **10:55 - Morning tea**
- **11:15 - Adoption strategies** (fishbowl format)
...
- **13:30 - Designing policies with their digital twins**
  - _How housing support did not get reformed (New Caledonia)_
  - LexImpact (Parliament, France)
- **14:00 - Delivering policies to end users**
  - Benefit navigator (GovTechTokyo, Japan)
  - Eligibility to join the Air Force Cadets (Department of Defence, Australia)
- **14:30 - New tools for policy modelling**
Highlight of recent products from members of the Association.
  - DocRef (Syncopate)
  - Codify (Assemblic)
- **15:00 - The future of modelling**
  - Models to start from Zero (Koichiro Shiratori, Institute for poverty prevention, Japan)
  - Scaling rules intelligence (Possum Hodgkin, Department of Finance, Australia)
- **15:30 - Afternoon tea**
- **15:50 - Working groups**
...
- **16:50 - Digital commons like OpenFisca are critical infrastructure** _(sponsor speech)_
