...
- **13:35 - Designing policies with their digital twins**
  ...
  - How LexImpact uses OpenFisca to model the impact of the finance bill on the budget of the State (Sandra Chakroun, Parliament, France)
...
Highlight of recent products from members of the Association.
  - DocRef (Hamish Fraser, Syncopate)
  - Codify (Kurt Foster, Assemblic)
